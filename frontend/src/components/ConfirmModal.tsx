...
export const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-white dark:bg-neutral-900 rounded-2xl border border-gray-200 dark:border-neutral-700 shadow-lg p-6 animate-in fade-in zoom-in-95 duration-200">
        <button
          onClick={onCancel}
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <div className="space-y-2">
            <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 tracking-tight">{title}</h3>
          ...
          <div className="flex gap-3 w-full mt-2">
            ...
            <button
              onClick={onConfirm}
              className={`flex-1 px-4 py-2.5 font-semibold rounded-xl border border-gray-200 dark:border-neutral-700 shadow-sm hover:shadow-md transition-all duration-200 ${isDangerous
